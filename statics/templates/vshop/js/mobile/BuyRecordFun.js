        ...
        var n = function() {
            ...
            function(r) {
                if (r.Code == 0) {
                    ...
                    var p = q.length;
                    for (var o = 0; o < p; o++) {
                        s += '<ul><li class="rBg"><a href="/userpage/' + q[o].userWeb + '"><img src="/UserFace/' + q[o].userPhoto + '"><s></s></a></li><li class="rInfo"><a href="/userpage/' + q[o].userWeb + '">' + q[o].userName + "</a><strong>(" + q[o].buyIPAddr + " IP:" + q[o].buyIP + ')</strong><br><span>购买了<b class="orange">' + q[o].buyNum + '</b>人次</span><em class="arial">' + q[o].buyTime + "</em></li><i></i></ul>"
                    }
                    d.append(s);
                    if (i.EIdx < a) {
                        j.show()
