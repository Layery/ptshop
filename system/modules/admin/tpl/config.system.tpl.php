...
<form name="myform" action="" method="post">
  ...
  <table width="100%" cellspacing="0">	
	  ...
	  <tr>
		  ...
		  <td width="220" align="right">积分兑换：</td>

		  <td><input type="text" name="integral" value="<?php echo $web['integral']; ?>"  class="input-text">
			  <span>积分兑换：1元可以抵多少积分；比如：1元 = 1000分，为空不能使用积分抵现</span>
