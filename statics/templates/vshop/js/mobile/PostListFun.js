            ...
            function(z) {
                if (z.code == 0) {
                    ...
                    for (var w = 0; w < y.length; w++) {
                        ...
                        B += '<dl class="fl"><a href="/userpage/' + y[w].userWeb + '"><img src="/UserFace/' + y[w].userPhoto + '"><b></b></a></dl>';
                        ...
                        for (var v = 0; v < u.length; v++) {
                            B += '<img src="' + Gobal.LoadPic + '" src2="/userpost/small/' + u[v] + '" />'
                        }
                        B += "</li>";
