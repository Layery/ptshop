...
class Refund_pub extends Wxpay_client_pub
{
	...
	function __construct() {
		//设置接口链接https://api.mch.weixin.qq.com/secapi/pay/refund
	...
	function postXmlSSLCurl($xml,$url,$second=30){
		...
		$apiclient_cert = dirname(__FILE__).DIRECTORY_SEPARATOR.'cacert'.DIRECTORY_SEPARATOR.'apiclient_cert.pem';
		$apiclient_key = dirname(__FILE__).DIRECTORY_SEPARATOR.'cacert'.DIRECTORY_SEPARATOR.'apiclient_key.pem';
		$rootca = dirname(__FILE__).DIRECTORY_SEPARATOR.'cacert'.DIRECTORY_SEPARATOR.'rootca.pem';
        ...
        if($data){
            ...
            echo "<a href='http://curl.haxx.se/libcurl/c/libcurs.html'>;错误原因查询1</a><br/>";
            curl_close($ch);
            echo false;
