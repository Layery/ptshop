...
<head>
    ...
    <script language="javascript" type="text/javascript">
        $(function () { var e = $("#qr_box"); var c = $("#guide"); c.css({ left: "50%", opacity: 0 }); e.hover(function () { c.css("display", "block").stop().animate({ marginLeft: "+156px", opacity: 1 }, 900, "swing", function () { c.animate({ marginLeft: "+143px" }, 300) }) }, function () { c.stop().animate({ marginLeft: "-101px", opacity: 0 }, "400", "swing", function () { c.hide() }) }); var d = $("#hidShopID").val(); var b = 0; var a = function () { $.getJSON(" ", function (f) { if (f.state == 0) { if ($("#hidIsBuyPay").val() == "0") { location.replace("") } else { location.replace("" + d) } } else { b++; setTimeout(a, 3000 + parseInt(b / 20) * 1000) } }) }; setTimeout(a, 10000) });
    </script>	
</head>
<body>
                        ...
                        <div class="area_bd"><span class="wx_img_wrapper"  id="qr_box">
						   ...
						   <div id="resmsgdiv"></div>
                            ...
                            <div class="msg_box"><i class="icon_wx pngFix"></i>
                                <p><strong>扫描成功后</strong>请在手机确认支付</p>
                            </div>
                        </div>
                    </div>
                </div>
			...
			setInterval(function(){
			  $.ajax({
				...
				success: function(res){
				    if(res.code==1){
						alert("充值成功!");window.location.href = '<?php echo WEB_PATH;?>/member/home';
					}
