...
<form method="post" action="">
	<table width="100%"  cellspacing="0" cellpadding="0">
		<tr>
			...
			<td><input  type="text"  name="title" id="title" onKeyUp="return gbcount(this,100,'texttitle');"  class="input-text wid400 bg" value="<?php echo $res['title'];?>">
		...
		<tr>
			...
			<td><textarea name="content" id="content" cols="80" rows="100" style="height: 80px;"><?php echo $res['content'];?></textarea>
            </td>  
		</tr>
       <tr>
			<td align="right">发布时间：</td>
			<td>           
            	<input name="posttime" type="text" id="posttime" value="<?php echo date("Y-m-d H:i:s",$res['updatetime']); ?>" class="input-text posttime"  readonly="readonly" />
				<script type="text/javascript">
				date = new Date();
				Calendar.setup({
					inputField     :    "posttime",
        ...
        <tr>
            ...
            <td>
				...
				<?php }else{?>
					<label><input type="radio" name="declare_act" value="a">活动　</label>
					<label><input type="radio" name="declare_act" value="d" checked="checked">公告</label>
				<?php }?>
			</td>
			<td>
            </td>             
        ...
        <tr height="60px">
			...
			<td>
				...
				<input type="submit" name="dosubmit" class="button" value="添加内容" />
			</td>
		</tr>
	</table>
</form>
