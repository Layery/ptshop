...
//        echo templates("mobile/invite","friends");
...
//		p($member);
        ...
        $zhichutotal=0;
        $uids = $member['uid'];
        $invifriends=$mysql_model->GetList("select * from `@#_member` where `yaoqing1` like '%$uids%'  ORDER BY `time` DESC");//`yaoqing1` like '%$uids2%' 
...
//            $user[$sqluid]['jb'] =  $recodes[$sqluid]['jb'];
