...
<form name="myform" action="" method="post" enctype="multipart/form-data">
	<table width="100%" cellspacing="0">
			...
			<td width="120" align="right">所属商城:</td>
		  	<td>
				<select name="category" class="wid120">
					<option value="0">≡ 活动商城 ≡</option>
					<option value="1">≡ 装备商城 ≡</option>
					<option value="2">≡ 一元拼商城 ≡</option>
				</select>
		...
		<tr>
            ...
            <td>
				<img height="50px" id="show-img" src="<?php echo WEB_PATH;?>/statics/uploads/photo/goods.jpg"/>
