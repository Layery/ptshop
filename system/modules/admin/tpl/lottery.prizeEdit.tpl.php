...
<form method="post" action="">
	...
	<table width="100%" id="general-table" cellspacing="0" cellpadding="0">
        <tr>
			...
			<td>
            <input  type="text" id="title"  name="title" value="<?php echo $prize_one['p_title']?>" onKeyUp="return gbcount(this,100,'texttitle');"  class="input-text wid400 bg" placeholder="奖项名称，比如：一等奖、二等奖、三等奖...">
		...
		<tr>
			...
			<td>
				<input type="text" id="countdown" class="input-text" style="width:65px;padding-left:0px;text-align:center" name="countdown"  value="<?php echo $prize_one['p_lottery_time']?>" />
				<span class="lr10">倒计时时间单位是分钟</span>
			</td>
		</tr>
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>每次抽奖人数：</td>
			<td><input type="text" name="hit_num" value="<?php echo $prize_one['p_hit_num']?>" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px;padding-left:0px;text-align:center" class="input-text" >（位/每次）　<span class="lr10">每次抽奖人数</span></td>
		</tr>
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>抽奖总人数：</td>
			<td><input type="text" name="award_num" value="<?php echo $prize_one['p_award_num']?>" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px;padding-left:0px;text-align:center" class="input-text" >位　<span class="lr10">中奖总人数</span></td>
		</tr>
		<tr>
			<td align="right" style="width:120px">奖品名称：</td>
			<td>
				<input type="text" name="prize_item" value="<?php echo $prize_one['p_item']?>" id="prize_item" class="input-text wid300" placeholder="奖品名称" />
	...
	<div class="submit-btn" style="background:#f6f6f6;margin-top: 10px;padding: 5px 140px;">
		<input type="hidden" name="prize_id" value="<?php echo $prize_one['p_id']?>">
