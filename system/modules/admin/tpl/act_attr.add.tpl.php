...
<form method="post" action="">
	<table width="100%"  cellspacing="0" cellpadding="0">
		<tr style="background-color:#FFC">
			<td align="right" style="width:120px"><b>提示：</b></td>
			<td>
				<font color="red">筛选属性目前只能一个分类最多添加两个；发布活动时也可以添加属性值。</font><br />
			</td>
		</tr>
		<!--<tr>
        ...
        <tr>
			...
			<td>
            <input  type="text" id="attr_name"  name="name" class="input-text bg">
            </td>
		</tr>
		<tr>
        ...
        <tr>
			<td align="right" style="width:120px"><font color="red">*</font>属性值：</td>
			<td><textarea name="attr_value" class="wid400" onKeyUp="gbcount(this,250,'textdescription');" style="height:80px"></textarea><br><span>还能输入<b id="textdescription">250</b>个字符</span>
            </td>
		</tr>
		<tr>
