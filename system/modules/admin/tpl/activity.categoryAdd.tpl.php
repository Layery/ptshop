...
<div class="table-list con-tab lr10" id="con-tab">
    ...
    <table width="100%" class="table_form">
        ...
        <tr>
            <th>分类名称：</th>
            <td>
                <input type="text" name="name" class="input-text wid140" onKeyUp="value=value.replace(/[^a-zA-Z0-9\u4E00-\u9FA5\_]/g,'')">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" id="imagetext" name="act_icon" value="photo/goods.jpg" class="input-text wid300">
        ...
        <tr>
            ...
            <td>
                ...
                <span style="margin: 77px;"><font color="#0c0">※ </font>分类显示</span>
            </td>
        </tr>
        <tr>
            <th>排序：</th>
