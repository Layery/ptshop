            ...
            function(q) {
                if (q.code == 0) {
                    ...
                    for (var p = 0; p < r; p++) {
                        ...
                        o += "<li onclic=\"location.href='"+Gobal.Webpath+"mobile/mobile/jf_item/" + n[p].shopid + '\'"><a class="fl z-Limg" >';
                        if (m == 1) {
						...
						/* add by cwq at 201.04.09 */
							...
							o += "<div>状态：" + stus_w + '</br> 物流公司：' + n[p].company + '  快递订单号：' + n[p].company_code + '</div>';
