...
class wxloginlottery extends SystemAction {
	...
	public function __construct(){	
		...
		if($user){
		    header("Location:".WEB_PATH."/mobile/mobile/shakereward");
            exit;
		}
	}
	...
	public function init(){
		...
		$url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$this->conf['weixin']['id'].'&redirect_uri='.WEB_PATH.'/api/wxloginlottery/callback&response_type=code&scope=snsapi_base&state=wechat123&connect_redirect=1#wechat_redirect';
		header("location:$url");
	}
	//wexin回调
