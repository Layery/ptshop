...
class setting extends admin {	
	...
	public function __construct(){
		...
		$this->ment=array(
            ...
            /*array("share","分享设置",ROUTE_M.'/'.ROUTE_C."/share"),*/
    ...
    /**
     * 分享设置：设置其类型，比如：系统，活动，装备，等
     */
    public function share(){
        $type = System::load_sys_config("share","type");
        //var_dump($type);exit;
	...
	public function config(){
		...
		if(isset($_POST['dosubmit'])){		
            ...
            //17.02.20 增加积分兑换
            $this->db->Query("UPDATE `@#_config` SET `value`=$integral WHERE `name`='integral'");
...
HTML;
	...
	public function mobile(){
		...
		if(isset($_POST['dosubmit'])){
            ...
            $cfg_templateid = trim(isset($_POST['templateid']) ? $_POST['templateid'] : '');
            ...
            $mobiles[$key]['templateid'] = $cfg_templateid;
