  ...
  <table width="100%" cellspacing="0">
  	 <tr>
		...
		<tr>
			...
			<td>
				<input type="text" name="fufen_yongjin" maxlength="4" value="<?php echo $config['fufen_yongjin'];?>" class="input-text">&nbsp;&nbsp;&nbsp;&nbsp;(三级)<input type="text" name="sanji_yongjin" value="<?php echo $config['sanji_yongjin'];?>" class="input-text">(一级:二级:三级)
			</td>
		</tr>
		<tr>
