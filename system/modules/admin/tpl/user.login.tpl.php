...
body{
	background: url(/images/beiying.png) no-repeat center center;
...
input[type="button"]:hover{
	background:rgba(53, 145, 171, 0.88);
	color:#fff;
}
/****************/
.copy-right {
	...
	<div class="main">
		<div class="login-form">
		 ...
		 <form action="#" method="post" id="form">
				<input type="text" class="text" id="input-u" name="username" value="管理员账户" />
				<input type="password" id="input-p" name="password" value="******" />
				<div class="submit">
				<input type="button" id="form_but" value="登录" >
				<input class="ipt" type="hidden" id="input-c" name="code" placeholder="验证码" value="">
				</div>	
				 
	 </form>
		</div>
		<div class="copy-right">版权所有  2015-2016 <a href="http://www.taeer.com" target="_blank">淘尔科技</a></div>
	</div>
