...
<form name="myform" action="" method="post">
  ...
  <table width="100%" cellspacing="0">
	...
	<tr>
	  ...
	  <tr>
		  <td width="220" align="right">申请退款通知openid：&nbsp;</td>
		  <td><input type="text" value="<?php echo $wechat[15]['cfg_value']; ?>" name="openid" class="input-text wid200"><font>说明:请点击
				  <a href="<?php echo WEB_PATH ?>/pmd" target="_blank" style="color: red;font-weight: bold;"> 数据库 </a>进行登录，选择`go_member`数据表，选择一个用户的`wxid`作为退款通知的接收者 </font></td>
	  </tr>
	  <tr>
		  <td width="220" align="right">申请退款通知模板：&nbsp;</td>
		  <td><input type="text" value="<?php echo $wechat[16]['cfg_value']; ?>" name="template_re" class="input-text wid200"></td>
	  </tr><tr>
		  <td width="220" align="right">退款成功通知模板：&nbsp;</td>
		  <td><input type="text" value="<?php echo $wechat[17]['cfg_value']; ?>" name="template_tk" class="input-text wid200"></td>
	  </tr>
	<tr>
	...
	<!--<tr>
	  ...
	  <tr>
		  <td width="220" align="right">活动报名通知模板：&nbsp;</td>
		  <td><input type="text" value="<?php echo $wechat[14]['cfg_value']; ?>" name="template_act" class="input-text wid200"></td>
	  </tr>
      <tr>
          <td width="220" align="right">分享返积分通知模板：&nbsp;</td>
          <td><input type="text" value="<?php echo $wechat[18]['cfg_value']; ?>" name="template_sc" class="input-text wid200"></td>
      </tr>
    <tr>
